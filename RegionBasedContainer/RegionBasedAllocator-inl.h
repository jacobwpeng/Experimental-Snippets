...
std::unique_ptr<AllocatorType> AllocatorType::Restore(char* data,
  ...
  if(header->magic != kMagic
      || header->size > max_node_id
      || header->element_size != sizeof(T)
      || header->free_list > max_node_id
...
template<typename T>
typename AllocatorType::NodeID* AllocatorType::NodeIDToNodeIDPtr(
    NodeID index) {
