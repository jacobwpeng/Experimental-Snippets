...
#define  __REGIONBASEDALLOCATOR_H__
...
class RegionBasedAllocator<T,
 ...
 public:
   ...
   static std::unique_ptr<RegionBasedAllocator> Create(char* data,
       size_t size, Header* header = nullptr);
   static std::unique_ptr<RegionBasedAllocator> Restore(char* data,
       size_t size, Header* header = nullptr);
   NodeID Allocate();
...
#endif   /* ----- #ifndef __REGIONBASEDALLOCATOR_H__  ----- */
