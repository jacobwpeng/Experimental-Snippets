...
const ::google::protobuf::Descriptor* ExchangePresentsInfo_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  ExchangePresentsInfo_reflection_ = NULL;
const ::google::protobuf::EnumDescriptor* SendRecordType_descriptor_ = NULL;
const ::google::protobuf::EnumDescriptor* ReceiveRecordType_descriptor_ = NULL;
...
void protobuf_AssignDesc_userinfo_2eproto() {
  ...
  static const int ReceiveRecord_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ReceiveRecord, uin_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ReceiveRecord, type_),
  };
  ...
  Notification_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Notification));
  ExchangePresentsInfo_descriptor_ = file->message_type(5);
  static const int ExchangePresentsInfo_offsets_[7] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, send_records_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, receive_records_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, request_records_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, notifications_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, uin_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, last_login_time_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, unprocessed_message_count_),
  };
  ExchangePresentsInfo_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ExchangePresentsInfo_descriptor_,
      ExchangePresentsInfo::default_instance_,
      ExchangePresentsInfo_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ExchangePresentsInfo, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(ExchangePresentsInfo));
  SendRecordType_descriptor_ = file->enum_type(0);
  ReceiveRecordType_descriptor_ = file->enum_type(1);
  NotificationType_descriptor_ = file->enum_type(2);
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    ExchangePresentsInfo_descriptor_, &ExchangePresentsInfo::default_instance());
}
...
void protobuf_ShutdownFile_userinfo_2eproto() {
  ...
  delete ExchangePresentsInfo::default_instance_;
  delete ExchangePresentsInfo_reflection_;
}
...
void protobuf_AddDesc_userinfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\002(\r\022\035\n\004type\030\002 \002(\0162\017.SendRecordType\">\n\rRe"
    "ceiveRecord\022\013\n\003uin\030\001 \002(\r\022 \n\004type\030\002 \002(\0162\022"
    ".ReceiveRecordType\"\034\n\rRequestRecord\022\013\n\003u"
    "in\030\001 \002(\r\"\\\n\014Notification\022\013\n\003uin\030\001 \002(\r\022\037\n"
    "\004type\030\002 \002(\0162\021.NotificationType\022\036\n\ngoods_"
    "list\030\003 \003(\0132\n.GoodsInfo\"\372\001\n\024ExchangePrese"
    "ntsInfo\022!\n\014send_records\030\001 \003(\0132\013.SendReco"
    "rd\022\'\n\017receive_records\030\002 \003(\0132\016.ReceiveRec"
    "ord\022\'\n\017request_records\030\003 \003(\0132\016.RequestRe"
    "cord\022$\n\rnotifications\030\004 \003(\0132\r.Notificati"
    "on\022\013\n\003uin\030\005 \002(\r\022\027\n\017last_login_time\030\006 \002(\r"
    "\022!\n\031unprocessed_message_count\030\007 \002(\r*2\n\016S"
    "endRecordType\022\n\n\006ACTIVE\020\001\022\024\n\020RESPONSE_RE"
    "QUEST\020\002*=\n\021ReceiveRecordType\022\023\n\017BY_SELF_"
    "REQUEST\020\001\022\023\n\017BY_OTHER_ACTIVE\020\002*6\n\020Notifi"
    "cationType\022\020\n\014REQUEST_GIFT\020\001\022\020\n\014RECEIVE_"
    "GIFT\020\002", 726);
  ...
  ExchangePresentsInfo::default_instance_ = new ExchangePresentsInfo();
  ...
  ExchangePresentsInfo::default_instance_->InitAsDefaultInstance();
...
const ::google::protobuf::EnumDescriptor* ReceiveRecordType_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ReceiveRecordType_descriptor_;
}
...
const int ReceiveRecord::kTypeFieldNumber;
#endif  // !_MSC_VER
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::ReceiveRecordType_IsValid(value)) {
            set_type(static_cast< ::ReceiveRecordType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(2, value);
          }
        } else {
...
#ifndef _MSC_VER
const int ExchangePresentsInfo::kSendRecordsFieldNumber;
const int ExchangePresentsInfo::kReceiveRecordsFieldNumber;
const int ExchangePresentsInfo::kRequestRecordsFieldNumber;
const int ExchangePresentsInfo::kNotificationsFieldNumber;
const int ExchangePresentsInfo::kUinFieldNumber;
const int ExchangePresentsInfo::kLastLoginTimeFieldNumber;
const int ExchangePresentsInfo::kUnprocessedMessageCountFieldNumber;
#endif  // !_MSC_VER

ExchangePresentsInfo::ExchangePresentsInfo()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void ExchangePresentsInfo::InitAsDefaultInstance() {
}

ExchangePresentsInfo::ExchangePresentsInfo(const ExchangePresentsInfo& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void ExchangePresentsInfo::SharedCtor() {
  _cached_size_ = 0;
  uin_ = 0u;
  last_login_time_ = 0u;
...
void ExchangePresentsInfo::SharedDtor() {
  if (this != default_instance_) {
  }
}

void ExchangePresentsInfo::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* ExchangePresentsInfo::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ExchangePresentsInfo_descriptor_;
}

const ExchangePresentsInfo& ExchangePresentsInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_userinfo_2eproto();
  return *default_instance_;
}

ExchangePresentsInfo* ExchangePresentsInfo::default_instance_ = NULL;

ExchangePresentsInfo* ExchangePresentsInfo::New() const {
  return new ExchangePresentsInfo;
}

void ExchangePresentsInfo::Clear() {
...
bool ExchangePresentsInfo::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_unprocessed_message_count;
        break;
      }
...
void ExchangePresentsInfo::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // repeated .SendRecord send_records = 1;
  ...
  if (has_unprocessed_message_count()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->unprocessed_message_count(), output);
  }
...
::google::protobuf::uint8* ExchangePresentsInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // repeated .SendRecord send_records = 1;
  for (int i = 0; i < this->send_records_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
  ...
  // required uint32 unprocessed_message_count = 7;
  if (has_unprocessed_message_count()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->unprocessed_message_count(), target);
  }
...
int ExchangePresentsInfo::ByteSize() const {
  int total_size = 0;
...
void ExchangePresentsInfo::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const ExchangePresentsInfo* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const ExchangePresentsInfo*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void ExchangePresentsInfo::MergeFrom(const ExchangePresentsInfo& from) {
  GOOGLE_CHECK_NE(&from, this);
...
void ExchangePresentsInfo::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ExchangePresentsInfo::CopyFrom(const ExchangePresentsInfo& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ExchangePresentsInfo::IsInitialized() const {
...
void ExchangePresentsInfo::Swap(ExchangePresentsInfo* other) {
  if (other != this) {
...
::google::protobuf::Metadata ExchangePresentsInfo::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = ExchangePresentsInfo_descriptor_;
  metadata.reflection = ExchangePresentsInfo_reflection_;
  return metadata;
}
